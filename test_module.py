...
class UnitTests(unittest.TestCase):
    def test_arrangement(self):
        actual = arithemtic_arranger(["3 + 855", "3801 - 2", "45 + 43", "123 + 49"])
        expected = "    3      3801      45      123\n+ 855    -    2    + 43    +  49\n-----    ------    ----    -----"
        self.assertEqual(actual, expected, 'Expected different output when calling "arithmetic_arranger()" with ["3 + 855", "3801 - 2", "45 + 43", "123 + 49"]')

        actual = arithemtic_arranger(["11 + 4", "3801 - 2999", "1 + 2", "123 + 49", "1 - 9380"])
    ...
    def test_too_many_problems(self):
        actual = arithemtic_arranger(["44 + 815", "909 - 2", "45 + 43", "123 + 49", "888 + 40", "653 + 87"])
    ...
    def test_too_many_digits(self):
        actual = arithemtic_arranger(["24 + 85215", "3801 - 2", "45 + 43", "123 + 49"])
    ...
    def test_only_digits(self):
        actual = arithemtic_arranger(["98 + 3g5", "3801 - 2", "45 + 43", "123 + 49"])
    ...
    def test_solutions(self):
        actual = arithemtic_arranger(["32 - 698", "1 - 3801", "45 + 43", "123 + 49"], True)
